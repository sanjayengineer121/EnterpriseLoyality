...
lb=tb.Label(bootstyle="info",text="Customer Name",font=font)
lb.place(x=100,y=100)

e = tb.Entry()
e.configure(state="success")
e.place(x=100,y=130,width=250)
...
submitb.place(x=500,y=130,width=150)

# info colored frame style
lbframe=tb.Frame(bootstyle="info",width=1050,height=50)
lbframe.place(x=0,y=170)

centered_text = "Coupans Categary"
...
submitb.place(x=100,y=230,width=150)

submitb = tb.Button(
    root,
    # image=img,
    text = "Expired Coupans",
    width=20,
    compound=LEFT,
    style='danger.Outline.TButton',
    command = sendtoparty,
    )
submitb.place(x=300,y=230,width=150)

submitb = tb.Button(
    root,
    # image=img,
    text = "Redeemed Coupans",
    width=20,
    compound=LEFT,
    style='INFO.Outline.TButton',
    command = sendtoparty,
    )
submitb.place(x=500,y=230,width=150)
